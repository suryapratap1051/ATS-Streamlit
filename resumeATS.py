...
# Streamlit UI
st.set_page_config(page_title="ResumeATS", layout="wide")
...
st.title("APPWARS ResumeATS System")
...
analysis_option = st.radio("Choose analysis type:", 
                           ["Quick Scan", "Detailed Analysis", "ATS Optimization", "Resume Score"])
...
if st.button("Analyze Resume"):
    if upload_file is not None:
        ...
        if analysis_option == "Quick Scan":
            ...
            prompt = f"""
            You are ResumeChecker, an expert in resume scoring. Evaluate the following resume and provide a score based on the following criteria:
            
            1. Clarity of information (out of 10)
            2. Relevance to the job description (out of 10)
            3. Use of action verbs (out of 10)
            4. Formatting and structure (out of 10)
            5. Overall presentation (out of 10)
            
            Provide an overall score out of 100 and explain the reasoning behind each score.
...
st.sidebar.title(" APPWARS-Resources")
st.sidebar.markdown("""
- [Resume Writing Tips](https://appwarstechnologies.com/)
- [ATS Optimization Guide](https://appwarstechnologies.com/)
- [Interview Preparation](https://appwarstechnologies.com/)
""")
